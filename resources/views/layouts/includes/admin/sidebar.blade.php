...
<aside id="default-sidebar"
    ...
    <div class="h-screen divide-y bg-white px-3 py-4 text-gray-600">
        <div
            class="sidebar__header flex h-12 flex-row items-center justify-between">
            <x-application-logo
                class="hidden h-8 flex-shrink-0 px-2 md:flex lg:h-9">
            </x-application-logo>
        </div>
        <ul class="sidebar__content space-y-2 py-4 font-medium">
            ...
            <li x-data="{ expanded: false }">
                <button type="button"
                    ...
                    <span
                        class="ml-3 flex-1 whitespace-nowrap text-left">Products</span>
                    <svg fill="none" stroke="currentColor" stroke-width="1.5"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        aria-hidden="true" sidebar-toggle-item
