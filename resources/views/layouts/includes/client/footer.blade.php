    ...
    <div
        ...
        <div class="mx-auto w-64 flex-shrink-0 text-center md:mx-0 md:text-left">
            <a
                ...
                <svg class="h-5 w-auto fill-current text-gray-900"
                    viewBox="0 0 202 69" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div
            class="mt-10 -mb-10 flex flex-grow flex-wrap text-center md:mt-0 md:pl-20 md:text-left">
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <h2
                    class="title-font mb-3 text-sm font-medium uppercase tracking-widest text-gray-900">
                    About</h2>
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Company</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Careers</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Blog</a>
                    </li>
                </nav>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                ...
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Contact
                            Support</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Help
                            Resources</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Release
                            Updates</a>
                    </li>
                </nav>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                ...
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Terms
                            &amp; Privacy</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Pricing</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">FAQ</a>
                    </li>
                </nav>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                ...
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Send
                            a Message</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">Request
                            a Quote</a>
                    </li>
                    <li class="mt-3">
                        <a
                            class="cursor-pointer text-gray-500 hover:text-gray-900">+123-456-7890</a>
                    </li>
                </nav>
            </div>
        </div>
