...
<x-admin-layout>
    ...
    <div class="flex flex-col flex-wrap justify-between gap-4 lg:flex-row">
        ...
        <div class="flex flex-row justify-center flex-1 gap-2">
            <form class="flex items-center w-full">
                ...
                <button type="submit"
                    class="p-3 ml-0 text-sm font-medium text-white border border-gray-200 rounded-lg rounded-l-none focus:outline-none focus:ring-4 focus:ring-blue-300">
    ...
    <section class="mt-10">
        <ul class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
            <li>
                <div class="flex flex-col items-center justify-center p-5 font-bold bg-yellow-100 rounded-lg">
                    <div class="icon-wrap rounded-full bg-yellow-300 p-2.5">
                        <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                            ...
                            class="flex-shrink-0 w-6 h-6 rounded-full stroke-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
