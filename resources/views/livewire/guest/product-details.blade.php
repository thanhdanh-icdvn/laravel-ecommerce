<div>
    <div class="bg-white">
        <div class="max-w-2xl px-4 pt-16 pb-24 mx-auto sm:pt-24 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div class="flex flex-col-reverse">
                ...
                <div class="w-full aspect-w-1 aspect-h-1">
                    <img src="{{ $product->getFirstMediaUrl('media') }}" alt="Angled front view with bag zipped and handles upright." class="object-cover object-center w-full h-full sm:rounded-lg">
                </div>
            </div>
                    ...
                    <form wire:submit.prevent="addToCart">
                        ...
                        <div class="flex items-center mt-8 space-x-3">
                            <div>
                                ...
                                <x-input wire:model.lazy="addToCart.quantity" type="number" id="productQuantity" class="py-3 text-sm text-center w-28 sm:text-base" :min="$minQuantity" :max="$maxQuantity" />
                                <x-input-error for="addToCart.quantity" />
                            </div>
                            <div class="flex w-full">
                                <x-primary-button class="flex-1 max-w-xs px-8 py-3 font-medium sm:w-full sm:text-base disabled:cursor-not-allowed" :disabled="$maxQuantity == 0">
